...
const SubmitBtn = () => {
  ...
  return (
    ...
    focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition-all disabled:scale-100 disabled:bg-opacity-65 dark:bg-white dark:bg-opacity-10"
      disabled={pending}
    >
      {pending ? (
