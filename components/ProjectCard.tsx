  ...
  return (
    ...
    >
     ...
     border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem]
      hover:bg-gray-200 transition group-even:pl-8 rounded-lg dark:bg-white/10 dark:hover:bg-white/20"
      >
        <div
      ...
      h-full group-even:ml-[18rem]"
        >
          ...
          <ul className="flex flex-wrap items-center mt-4 gap-2 sm:mt-auto last:mb-0">
            {tags.map((tag, index) => (
              <li
